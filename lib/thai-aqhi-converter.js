...
export function calculateThaiAQHI(pm25, o3, no2, pm10 = null) {
  console.log(`🇹🇭 Calculating Thai AQHI: PM2.5=${pm25}μg/m³, PM10=${pm10}μg/m³, O3=${o3}ppb, NO2=${no2}ppb`);
  ...
  const perErPM10 = pm10 ? 100 * (Math.exp(THAI_COEFFICIENTS.beta.pm10 * pm10) - 1) : 0;
  ...
  console.log(`🎯 Thai AQHI %ER: PM2.5=${perErPM25.toFixed(2)}%, PM10=${perErPM10.toFixed(2)}%, O3=${perErO3.toFixed(2)}%, NO2=${perErNO2.toFixed(2)}%, Total=${totalPerER.toFixed(2)}%`);
